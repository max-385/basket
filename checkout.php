...
<div class="container">
    ...
    <div class="row row-cols-2 offset-2">
            <div class="custom-control custom-radio">
                <input type="radio" id="cardRadio" name="paymentRadio" class="custom-control-input" checked  onclick="$('#ibanPayment').hide(); $('#cardPayment').show();">
                <label class="custom-control-label" for="cardRadio"><i class="fab fa-cc-visa"> Credit card</i></label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" id="ibanRadio" name="paymentRadio" class="custom-control-input" onclick="$('#cardPayment').hide(); $('#ibanPayment').show();">
                <label class="custom-control-label" for="ibanRadio"><i class="fas fa-university"> IBAN</i></label>
            </div>
    </div>

        <!-- Checkout card form-->
        <form id="cardPayment" method="post" class="needs-validation" novalidate>

            <!-- Card type-->
            <div class="form-group">
                <label for="CheckoutCardType">Card type</label>
                <select class="custom-select form-control" id="CheckoutCardType" required>
            ...
            <div class="form-group">
                ...
                <input name="nameOnCard" type="text" class="form-control" id="checkoutCardName" placeholder="Name surname" minlength="5" maxlength="50" pattern="[A-Z a-z-]+" required>
                <div class="invalid-tooltip">
                    Incorrect name
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="cardNumber" type="text" class="form-control" id="checkoutCardNum" placeholder="Card number" minlength="16" maxlength="16" pattern="[0-9]+" required>
                <div class="invalid-tooltip">
            ...
            <input name="expiryMonth" type="text" pattern="[0-9]+" class="form-control" id="checkoutExpiryMonth" placeholder="Month" minlength="2" maxlength="2" required>
                <div class="invalid-tooltip">
                    Incorrect month
                </div>
                </div>
            ...
            <input name="expiryYear" type="text" pattern="[0-9]+" class="form-control" id="checkoutExpiryYear" placeholder="Year" minlength="2" maxlength="2" required>
                <div class="invalid-tooltip">
                    Incorrect year
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="CVV" type="password" class="form-control" id="checkoutCVV" placeholder="CVV or CVC" minlength="3" maxlength="3" pattern="[0-9]+" required>
                <div class="invalid-tooltip ">
            ...
            <div class="form-group">
                ...
                <input name="phoneNum" type="tel" class="form-control" id="checkoutPhone" placeholder="Phone number" minlength="6" maxlength="20" pattern="[\+]{0,1}[0-9]+" required>
                <div class="invalid-tooltip">
            ...
            <div class="form-group">
                ...
                <input name="email" type="email" class="form-control" id="checkoutEmail" placeholder="E-mail" minlength="3" maxlength="30" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                <div class="invalid-tooltip">
        ...
        <form id="ibanPayment" method="post" class="needs-validation" style="display: none" novalidate>
            ...
            <div class="form-group">
                ...
                <input name="phoneNum" type="tel" class="form-control" id="checkoutPhoneBank" placeholder="Phone number" minlength="6" maxlength="20" pattern="[\+]{0,1}[0-9]+" required>
                <div class="invalid-tooltip">
                    Incorrect phone number format (it must contain only "+" sign and numbers)
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="email" type="email" class="form-control" id="checkoutEmailBank" placeholder="E-mail" minlength="3" maxlength="30" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                <div class="invalid-tooltip">
                    Incorrect e-mail entered
                </div>
            </div>
